  ...
  return (
    <AppLayout showBack={true}>
      <div className="flex-1 px-4 py-6">
        ...
        <div className="mb-4">
          <h4 className={`text-sm font-semibold ${textSecondaryClass} mb-2`}>امروز</h4>
          <HistoryItem text="لورم ایپسوم متن ساختگی" date="امروز" />
          <HistoryItem text="لورم ایپسوم متن ساختگی" date="امروز" />
        </div>

        <div className="mb-4">
          <h4 className={`text-sm font-semibold ${textSecondaryClass} mb-2`}>یک هفته پیش</h4>
          <HistoryItem text="لورم ایپسوم متن ساختگی" date="یک هفته پیش" />
          <HistoryItem text="لورم ایپسوم متن ساختگی" date="یک هفته پیش" />
        </div>

        <div>
          <h4 className={`text-sm font-semibold ${textSecondaryClass} mb-2`}>یک ماه پیش</h4>
